...
ReadSASFile <- function(SASFileName, DD){
    ...
    if (length(MissVar) > 0) stop(paste0('[RepoReadWrite::ReadSASFile] The following variables in the SAS file are not present in the Excel sheet:\n\n', 
    ...
    if (length(NoDDdt) > 0) {stop('[RepoReadWrite::ReadSASFile] The following variables in the SAS file are not present in the DD file:\n\n', 
