...
#'
#' @description \code{ExampleVNC} is an object of class \linkS4class{VarNameCorresp} with only one 
#' slot \code{MicroData}.
#'
...
#'
#' @format Object of class \code{VarNameCorresp}. Its slot \code{MicroData} has 16 rows and 9 
#' columns.
NULL
